...
const ExploreMore = () => {
  ...
  return (
    <div className=''>
      ...
      IELTS 
        <HighlightText text={"course"} />
      </div>

      <p className='text-center text-richblack-300 text-sm text-[16px] mt-3'>
      IELTS courses at AcademyUIT are always committed to ensuring student outcomes with the Linearthinking method and exclusive technology platform developed by AcademyUIT.
      </p>  
